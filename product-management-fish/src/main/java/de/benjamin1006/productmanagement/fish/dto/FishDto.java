 ...
 */
public class FishDto extends ProductDto {

    private FishCondition fishCondition;
    private LocalDate catchDate;
    private double basePrice;

    public FishDto(String type, int quality, double price, LocalDate expirationDate, FishCondition fishCondition, LocalDate catchDate) {
