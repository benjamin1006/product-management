...
public interface IEventManager {
     ...
     * @param product   das Objekt vom Typ Product, für das die Notification versendet wird.
     */
    void notifyProductObservers(EventType eventType, Product product);
     ...
     *
     * @param eventType   das Event für das die Notification versendet wird
     * @param productList die Liste vom Typ Product, für das die Notification versendet wird.
     */
    void notifyProductListObservers(EventType eventType, List<Product> productList);
}
